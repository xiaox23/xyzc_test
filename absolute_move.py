...
if __name__ == "__main__":
    ...
    """ c:-逆时 +顺时 """
    # X axis
    # controller.absoulte_movement('X', -10, speed)  #  x后退
    controller.absoulte_movement('X', 10, speed)  #  x前进
  
    # Y axis
    # controller.absoulte_movement('Y',  20, speed)  # y左移
    controller.absoulte_movement('Y',  -20, speed)  # y右移
